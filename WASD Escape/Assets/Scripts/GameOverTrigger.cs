...
///
/// 주의:
/// - 디자인용 타일맵인 WallTilemap_2에는 이 스크립트를 붙이면 안 됩니다.
/// - 같은 오브젝트에 Collider2D가 있어야 합니다.
/// - Trigger 방식이면 Collider2D의 Is Trigger를 체크합니다.
/// </summary>
public class GameOverTrigger : MonoBehaviour
{
    ...
    private void HandleHit(GameObject target)
    {
        ...
        // 어떤 오브젝트 때문에 리셋됐는지 확인하기 위한 로그입니다.
        Debug.Log("리셋 발생 오브젝트: " + gameObject.name);
